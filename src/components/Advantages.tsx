...
const Advantages = () => {
  ...
  useEffect(() => {
    ...
    if (advantagesRef.current) {
      const elements = advantagesRef.current.querySelectorAll('.reveal-text');
  ...
  return (
    <section 
      id="advantages" 
      className="py-24 relative bg-diic-blue text-white"
      style={{
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {advantages.map((advantage, index) => (
            <div 
              key={index}
              className="reveal-text bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
          {[
            ...
            <div key={index} className="reveal-text text-center">
