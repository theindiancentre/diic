                ...
                <div className="p-6 md:p-8 lg:p-12 bg-gradient-to-br from-diic-blue to-diic-deepBlue">
                  <div className="reveal-text">
                    ...
                    <div className="border-t border-white/20 pt-5 mb-5">
                      ...
                      <p className="text-diic-gold font-bold text-lg md:text-xl">Chairman Jaber Ahmed Darwish</p>
                      
                      <div className="flex flex-col space-y-3 mt-4">
                        <a 
                          href="mailto:contact@diic.ae" 
                          className="flex items-center text-white/80 hover:text-white transition-colors mobile-touch-target"
                        >
                    ...
                    <Button 
                      className="bg-diic-gold hover:bg-diic-gold/90 text-diic-blue font-medium mt-4 px-6 py-5 h-auto w-full sm:w-auto rounded-full transition-all transform hover:scale-105"
                    >
                      Connect With Us
                    </Button>
                  </div>
